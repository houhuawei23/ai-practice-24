...
from ui.Converter_dialog import Ui_Dialog
from scripts.isat import ISAT
from scripts.coco import COCO
from scripts.yolo import YOLO
from scripts.labelme import LABELME
from scripts.voc import VOC
from scripts.voc_detection import VOCDetect
import os
import yaml
import imgviz
...
class Converter(QThread, ISAT):
    ...
    def load_from_isat(self):
        ...
        if os.path.exists(os.path.join(self.isat_json_root, 'labels.yaml')):
            cates = []
            with open(os.path.join(self.isat_json_root, 'labels.yaml'), 'rb')as f:
    ...
    def convert_to_isat(self):
        ...
        with open(os.path.join(self.isat_json_root, 'labels.yaml'), 'w') as f:
            f.write(s)
